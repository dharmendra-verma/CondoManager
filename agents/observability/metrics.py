...
# CM-85: agentic-RAG trajectory shape (steps-to-answer + reformulation count).
METRIC_KNOWLEDGE_STEPS = "metric.knowledge.steps"
METRIC_KNOWLEDGE_REFORMULATED = "metric.knowledge.reformulated"
